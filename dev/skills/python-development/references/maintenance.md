...
- House ecosystem guidance stays uniform: uv, Ruff, MyPy, pytest, Pydantic,
  pydantic-settings, Typer, and Loguru.
- Tool commands use `uv run` forms unless the command is a uv command itself.
...
- Tooling changes quickly. Ruff, uv, pytest, MyPy, Pydantic,
  pydantic-settings, Typer, and Loguru advice should be checked against their
  docs when making strong claims.
...
technical freshness, and whether the house stack is applied consistently.
